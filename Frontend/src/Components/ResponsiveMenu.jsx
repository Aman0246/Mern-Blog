  ...
  return (
    <div>
      ...
      >
            ...
            <MenuItem><Link to={'/contact'} style={{ textDecoration: 'none', color: 'black' }}>CONTACT</Link> </MenuItem>
            <MenuItem> <Link to={'/create'} style={{ textDecoration: 'none', color: 'black', textTransform: 'uppercase' }}>Create_Blog</Link></MenuItem>
